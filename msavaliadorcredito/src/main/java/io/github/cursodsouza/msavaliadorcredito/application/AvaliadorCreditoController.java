...
import io.github.cursodsouza.msavaliadorcredito.application.ex.*;
...
public class AvaliadorCreditoController {
    ...
    public ResponseEntity realizarAvaliacao(@RequestBody DadosAvaliacao dados) {
        try {
            RetornoAvaliacaoCliente retornoAvalicaoCliente = avaliadorCreditoService.realizarAvaliacao(
